...
yarn_berry_config[version]="yarn@4.13.0"
...
yarn_berry_config[offline_ci_install]="yarn install --immutable"
yarn_berry_config[clean_cache_cmd]="yarn cache clean && rm -rf .yarn/cache"
...
#yarn_berry_config[setup_cmd]="yarn config set nodeLinker node-modules"
