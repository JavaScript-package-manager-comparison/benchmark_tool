...
vlt_config[full_install]="vlt install --yes"
vlt_config[ci_install]="vlt ci --yes"
vlt_config[offline_install]="vlt install --yes"
vlt_config[offline_ci_install]="vlt ci --yes"
